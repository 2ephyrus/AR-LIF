...
def main():
    ...
    parser.add_argument('-j', default=10, type=int, metavar='N', help='number of data loading workers (default: 10)')
    ...
    if args.dataset == 'cifar10' or args.dataset == 'cifar100':
        ...
        train_data_loader = DataLoader(trainset, batch_size=args.b, shuffle=True, num_workers=args.j)
        test_data_loader = DataLoader(testset, batch_size=args.b, shuffle=False, num_workers=args.j, drop_last=False, pin_memory=True)
        ...
        train_data_loader = DataLoader(trainset, batch_size=args.b, shuffle=True, num_workers=args.j, drop_last=True, pin_memory=True)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for data in train_data_loader:
            ...
            if args.amp:
                ...
                raise NotImplementedError(
                    'We do not implement mixed precision training for BPTT. Please implement it by yourself.')
            ...
            #  add at 2025/06/30 TINY_IMAGENET no need for argmax
